/* Copyright (C) Priyanka Tukaram Dombale priyanka.dombale24@gmail.com
 *
 * School Billing is free software: you can redistribute it and/or modify
        ...
        while(c=='y'||c=='Y')
        {
           system("clear");
            ...
            else if (choice==2)
            {
                ...
                {
                    a=1;
                    if (strcmp(name,stud.n)==0 && cl==stud.c)
                    {
                        a=0;
                        printf("\nenter new name of student: ");
                        fflush(stdin);
            ...
            else if (choice==3)
            {
                ...
                {
                    a=1;
                    if (strcmp(name,stud.n)==0 && cl==stud.c &&rolno==stud.r)
                    {
                        a=0;
                        printf("\nenter new name of student: ");
                        fflush(stdin);
...
void ext()
{
    ...
    printf("\tare you happy by the service?\n");
   //   
  // system("clear");
    //printf("\n\n\t\t\t Exiting\n\n");
    getchar();
